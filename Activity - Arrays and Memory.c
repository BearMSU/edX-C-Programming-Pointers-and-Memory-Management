...
int main(void) {
    ...
    */
    totalWet = cookie[0][0] + cookie[0][1]; // Added line
    ...
    */
    totalDry = *cookie[1] + *(cookie[1] + 1) + *(cookie[1] + 2); // Added line
    ...
    */
    *(*cookie) = totalWet/2; // First added line
    *(*cookie + 1) = totalWet/2; // Second added line
